...
export default function GraphView() {
	...
	const createGraph = (notes: Note[], folders?: Folder[]) => {
		...
		const colors = {
			textColor: isDarkTheme ? '#e2e8f0' : '#333', // Light grey in dark mode, dark grey in light mode
			linkColor: isDarkTheme ? '#6b7280' : '#999', // Medium grey in dark mode, light grey in light mode
			folderColor: '#34A853', // Keep folder color consistent (or could adjust shade based on theme)
			noteColor: '#4285F4', // Keep note color consistent (or could adjust shade based on theme)
		};
		...
		const node = container
			...
			.join('g')
			.call((g) => {
				// Different shapes for folders and notes - increased sizes
	...
	return (
		<div
			...
			<div
				className='w-full h-[800px] rounded-lg shadow-md border-1'
